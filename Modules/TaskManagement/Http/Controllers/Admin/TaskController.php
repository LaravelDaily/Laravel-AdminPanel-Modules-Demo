...
use Modules\TaskManagement\Http\Requests\MassDestroyTaskRequest;
...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('taskmanagement::admin.tasks.index', compact('tasks'));
    }
    ...
    public function create()
    {
        ...
        return view('taskmanagement::admin.tasks.create', compact('statuses', 'tags', 'assigned_tos'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        return view('taskmanagement::admin.tasks.edit', compact('statuses', 'tags', 'assigned_tos', 'task'));
    }
    ...
    public function show(Task $task)
    {
        ...
        return view('taskmanagement::admin.tasks.show', compact('task'));
    }
