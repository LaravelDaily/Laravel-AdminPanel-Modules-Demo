...
use Modules\ExpenseManagement\Http\Requests\MassDestroyIncomeCategoryRequest;
use Modules\ExpenseManagement\Http\Requests\StoreIncomeCategoryRequest;
use Modules\ExpenseManagement\Http\Requests\UpdateIncomeCategoryRequest;
use Gate;
...
class IncomeCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('expensemanagement::admin.incomeCategories.index', compact('incomeCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('expensemanagement::admin.incomeCategories.create');
    }
    ...
    public function edit(IncomeCategory $incomeCategory)
    {
        ...
        return view('expensemanagement::admin.incomeCategories.edit', compact('incomeCategory'));
    }
    ...
    public function show(IncomeCategory $incomeCategory)
    {
        ...
        return view('expensemanagement::admin.incomeCategories.show', compact('incomeCategory'));
    }
