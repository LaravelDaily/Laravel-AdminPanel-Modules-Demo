...
use Modules\ExpenseManagement\Entities\Income;
use Modules\ExpenseManagement\Http\Requests\MassDestroyIncomeRequest;
use Modules\ExpenseManagement\Http\Requests\StoreIncomeRequest;
use Modules\ExpenseManagement\Http\Requests\UpdateIncomeRequest;
use Gate;
use Illuminate\Http\Request;
use Symfony\Component\HttpFoundation\Response;
use Modules\ExpenseManagement\Entities\IncomeCategory;
...
class IncomeController extends Controller
{
    public function index()
    {
        ...
        return view('expensemanagement::admin.incomes.index', compact('incomes'));
    }
    ...
    public function create()
    {
        ...
        return view('expensemanagement::admin.incomes.create', compact('income_categories'));
    }
    ...
    public function edit(Income $income)
    {
        ...
        return view('expensemanagement::admin.incomes.edit', compact('income_categories', 'income'));
    }
    ...
    public function show(Income $income)
    {
        ...
        return view('expensemanagement::admin.incomes.show', compact('income'));
    }
